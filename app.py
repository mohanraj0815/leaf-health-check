...
def analyze_leaf_image(image_path):
    ...
    try:
        ...
        if st.session_state.model:
            ...
            disease_result = {'disease': 'Healthy', 'confidence': 0.95}
            plant_result = {'plant': 'Tomato', 'confidence': 0.90}
